...
<head>
    ...
    <title>Alumno - Centro de Salud</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="cursos_alumno.php">Cursos</a></li>
            <li><a href="ver_mensajes.php">Mensajes</a></li>
            <li><a href="logout.php" class="logout-btn">Cerrar Sesión</a></li>
        </ul>
    </div>
    <div class="content">
        <h1>Bienvenido, Alumno <?php echo $username; ?></h1>
